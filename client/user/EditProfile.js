...
export default function EditProfile({ match }) {
  ...
  useEffect(() => {
    ...
    read({
      ...
      if (data && data.error) {
        ...
        setValues({...values, id: data._id, name: data.name, email: data.email, about: data.about, educator: data.educator})
      }
    })
  ...
  const clickSubmit = () => {
    ...
    values.educator && user.append('educator', values.educator)
    values.about && user.append('about', values.about)
    // {
